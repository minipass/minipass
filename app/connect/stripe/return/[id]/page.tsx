            ...
            <div className="max-w-md w-full">
                <div className="bg-card border border-secondary rounded-lg shadow-lg overflow-hidden">
                    ...
                    <div className="bg-gradient-to-r from-green-500 to-green-600 p-6 text-white text-center">
                        ...
                        <p className="text-green-100">Sua conta Stripe foi conectada com sucesso</p>
                    </div>
                        ...
                        <div className="space-y-4">
                            <div className="bg-green-50 border border-green-100 rounded-sm p-4">
                                ...
                                <ul className="text-sm text-green-700 space-y-2">
                                    <li>• Agora você pode criar e vender ingressos para eventos</li>
                                    <li>• Os pagamentos serão processados através da sua conta Stripe</li>
                                    <li>• Os fundos serão transferidos automaticamente</li>
